...
/**
 * The Class JXPathCopier. It is used to copy the value of the field specified by the xpath. It supports multiple types
 * of values that can be copied like int, long, float, double, boolean , string and Object (custom). It also handles
 * repeated fields in protos for the types defined.
 */
